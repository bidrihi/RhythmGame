...
public class DynamicBeat extends JFrame {
    ...
    private final ImageIcon leftEnteredImage = new ImageIcon(Main.class.getResource("../images/leftEntered.png"));
    private final ImageIcon leftBasicImage = new ImageIcon(Main.class.getResource("../images/leftBasic.png"));
    private final ImageIcon rightEnteredImage = new ImageIcon(Main.class.getResource("../images/rightEntered.png"));
    ...
    private final ImageIcon backEnteredImage = new ImageIcon(Main.class.getResource("../images/backButtonEntered.png"));
    ...
    private final Image noteRouteImage = new ImageIcon(Main.class.getResource("../images/noteRoute.png")).getImage();
    ...
    public void screenDraw(Graphics2D g) {
        ...
        if (isGameScreen) {
            ...
            g.drawString("INFORMATION", 20, 702);
